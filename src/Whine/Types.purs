...
-- | A linting rule is just a function that takes a PureScript module and
...
newtype Rule = Rule (∀ e m. MonadRules () m => RangeOf e => CST.Module e -> m Unit)
...
class (Monad m, MonadLog m, MonadReport v m) <= MonadRules v m | m -> v
...
ruleFactory rid argsCodec construct =
  rid /\ \args ->
    case construct <$> CJ.decode argsCodec args of
      ...
      Left _ | JSON.isNull args -> Right $ Rule \_ -> pure unit
